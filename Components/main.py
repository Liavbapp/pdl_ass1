...
def train_complete_network():
    ...
    for epoch in range(0, HyperParams.num_epochs):
        train_data_batches = data_handler.pre_processing(train_x, train_y, HyperParams.batch_size)
        ...
        for batch_i in range(0, len(train_data_batches)):
            ...
            grads_dict = backward_pass(wb_dict, A_dict, Y_batch)
