...
def main():
    ...
    layers_dim = [num_features, 15, 10, num_labels]
    ...
    for epoch in range(0, HyperParams.num_epochs):
        ...
        if epoch % 1 == 0:
            ...
            train_loss = forward.cross_entropy_softmax_lost(A_train_dict[f'A{last_layer - 2}'], wb_dict[f'W{last_layer - 1}'], train_y)
            validation_loss = forward.cross_entropy_softmax_lost(A_test_dict[f'A{last_layer - 2}'], wb_dict[f'W{last_layer - 1}'], test_y)
